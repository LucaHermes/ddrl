...
from models.shared_graphnet_glorot_uniform_init import FullyConnectedNetwork_GNN_GlorotUniformInitializer
...
ModelCatalog.register_custom_model("gnn", FullyConnectedNetwork_GNN_GlorotUniformInitializer)
